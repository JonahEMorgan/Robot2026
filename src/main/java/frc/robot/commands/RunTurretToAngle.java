...
public class RunTurretToAngle extends Command {
	...
	private void clampedP(double current, double target, double p, double min, double max) {

	}

	/** Creates a new RunTurretAtSpeed. */
	public RunTurretToToAngle(Turret turretSubsystem, double speed, double rotations) {
	...
	public boolean isFinished() {
		return (m_turretSubsystem.getPosition() / 5) / 39.1 >= m_rot;
	}
}
